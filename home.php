                            ...
                            &nbsp;<div class="hero_moc hidden-sm hidden-xs"></div><!-- /.hero_moc -->
                                <div class="col-md-8">
                                    <div class="hero_content">
                                        ...
                                        <h1 style="color: #ffffff;">We are building something<br>Special...</h1>
                                        <br><br>
                                                <!-- Fullscreen homepage -->
                                        ...
                                        <div style="margin-left: 90px;">
                                            <a href="#subscribe" style="border-radius: 10px;" class="app_btn">Subscribe now</a>
                                        </div>
...
<section id="features" class="feature_section padding">
            <div class="container">
               ...
               <div class="feature_wrap">
                    ...
                    <div class="col-md-8">
                        <div class=" col-xs-6">
                            <ul class="feature_list text-right xs-no-padding" style="text-align: center;">
        ...
        <section id="testimonial" class="testimonial_section" style=" background-image: url(img/serbisyo1.jpg);">
			<div class="container">
				<div>
                ...
                <h4 class="glassmorphism" style="color: #ffffff; text-align: center; font-style: normal !important; font-weight: normal !important; text-transform: none; line-height: 1.5;
                 letter-spacing: 2 !important; word-spacing: 2 !important; ">
                        Abous Us:<br><br>
                        One home solutions is a property concierge in the<br>
                     Philippines. Designed to simplify the complexities of<br>
                      property management, we connect property owners<br>
                      with a wide network of accredited service providers<br>
                      and suppliers. Whether it's routine maintenance,<br>
                      renovation, or specialized services, our platform<br>
                      offers seamless access to trusted professionals.<br><br>

                      With a focus on innovation and quality, One Home<br>
                      Solutions is committed to setting new industry<br>
                      standards, making property management more<br>
                      efficient and stress-free. Our goal is to create a<br>
                      reliable and easy-to-use platform that helps property<br>
                      owners and take care of their investments with <br>
                      confidence. Whether you're managing a single home <br>
    ...
    <div class="subscribe_wrapper">
        <center>
            <div class="form-container">
                <form action="process.php" method="post" onsubmit="return validateForm()" id="myForms">
                    ...
                    <label for="gender"><h5>User Type</h5></label>
                    <div class="radio-group">
                        <input type="radio" id="subscriber" name="type" value="1" required>
                        <label for="subscriber"><h6>Subscriber</h6></label>
                        <input type="radio" id="service" name="type" value="2" required>
                        <label for="service"><h6>Service Provider</h6></label>
                    </div>

                    <label for="address"><h5>Message</h5></label>
                    <textarea id="address" name="message" rows="4" required></textarea>
