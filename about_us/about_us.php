			...
			<div class="owl-carousel owl-theme carousel_centered">
				<div class="item">
					<a href="#0">
						...
						</div><img src="<?php echo WEB_ROOT;?>img/staff/1_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="<?php echo WEB_ROOT;?>img/staff/2_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="<?php echo WEB_ROOT;?>img/staff/3_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="<?php echo WEB_ROOT;?>img/staff/4_carousel.jpg" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="<?php echo WEB_ROOT;?>img/staff/5_carousel.jpg" alt="">
					</a>
				</div>
			</div>
			<!-- /carousel -->
