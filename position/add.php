								...
								<div class="card border-top border-0 border-4 border-white">
									...
									<form class="needs-validation" novalidate method="post" action="process.php?action=add" enctype="multipart/form-data" name="form" id="form">					
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="pname" name="posname" placeholder="Position Name" autocomplete="off" required />
										...
										<div class="mb-3">
											...
											<textarea class="form-control" id="description" name="descript" placeholder="Description" autocomplete="off" required ></textarea>
											<div class="invalid-feedback">
